...
# ssm061基于SSM框架的个人博客网站的设计与实现+vue

![picture](https://raw.githubusercontent.com/GraduationProject-springboot/.github/main/img/wx.png)

### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1T48XecE9G?p=59)
...
第四点：可以降低信息管理成本；
## 1.3 研究内容
对个人博客网站设计制作，不仅需要技术支撑，也需要大量的理论研究。本文在对个人博客网站进行介绍时，将按照如下内容进行。

第一部分：介绍个人博客网站研究的背景意义，便于用户了解系统；

第二部分：介绍开发个人博客网站需要搭建的环境，包括技术和工具；

第三部分：介绍用户对个人博客网站的功能要求，以及对个人博客网站的性能要求等；
...
# 第2章 开发环境与技术
个人博客网站的编码实现需要搭建一定的环境和使用相应的技术，接下来的内容就是对个人博客网站用到的技术和工具进行介绍。
## 2.1 MYSQL数据库
...
### 3.1.2 经济可行性
本系统开发期间需要配置的软件环境，可以免费通过开发类官网下载安装，需要配置的硬件设备也不需要具备很高的性能，通常网吧电脑，或学校计算机机房的电脑都符合要求。因此，从经济方面考虑，个人博客网站开发可行。
### 3.1.3 操作可行性
个人博客网站根据用户使用习惯进行开发，设计的界面具有统一性，并具备优秀的导航功能。所以，只要会简单操作电脑的人员，可以无压力操作个人博客网站。
